...
#options {
  ...
  #stop_publish_button:hover {
    background-color: #45a049; /* Darker green on hover */
  }

  #stop_publish_button:disabled {
		...
		<div class="jumbotron">
			...
			<div class="form-group col-sm-12 text-left">
				<input type="text" class="form-control" id="streamId" name="streamIdTextBox"
					placeholder="Type stream ID" readonly>
			...
			<div class="button1">
<button class="btn btn-primary" id="start_publish_button" disabled>Start Publishing</button>
<button class="btn btn-primary" id="stop_publish_button" disabled>Stop Publishing</button>
